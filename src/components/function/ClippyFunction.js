...
export const clippyPhrase = {
    inspiration: [
        ...
        { phrase: "Have you tried creating a new folder? Just right-click to do it!", animation: clippy3 },
        { phrase: "Looking for Igna’s resume? You’ll find it in the 'Resume' folder!", animation: clippy4 },
        { phrase: "Stay positive – your attitude can change everything.", animation: clippy5 },
        { phrase: "TIP: You can't delete 'Recycle Bin' or 'My Computer'.'", animation: clippy6 },
        ...
        { phrase: "I can't solve a single Wordle. Turns out I'm not great at English!", animation: clippy6 },
